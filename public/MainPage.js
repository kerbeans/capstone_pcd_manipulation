...
const dummyListData = [{ id: 1, fileName: 'zeghtti.pcd', filePath: '/abc/zeghtti.pcd', display: false }, { id: 2, fileName: 'globalMap.pcd', filePath: '/ddd/globalMap.pcd', display: false }, { id: 3, fileName: 'mushapotei.pcd', filePath: 'mushapotei.pcd', display: false }, { id: 4, fileName: 'npx.lac', filePath: '/bs/npx.lac', display: false }];
...
class MainPage extends React.Component {
    ...
    filterServerFiles(searchKey) {
        ...
        for (var i in original) {
            if (original[i].fileName.search(searchKey) + 1) filteredList.push(original[i]);
        }
