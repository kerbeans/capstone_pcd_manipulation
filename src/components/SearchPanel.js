...
export default function SearchPanel(props){
    ...
    const handleFileChange = async (event) => {
      ...
      console.log('file loaded in SearchPanel',file)
      const reader = new FileReader();
      var mesh = null;
      reader.onload = (e) => {
        console.log('file target in e.target.result',e.target.result)
