    ...
    return(
      <Space
        ...
        style={{
          ...
          size={[0, 48]}>
        <Layout>
          <Sider width={'15%'} height={'100%'} style={siderStyle}>
            <DndProvider backend={HTML5Backend}>
                ...
                <button onClick={saveAsmesh} style={buttonstyle} title="saveasmesh">
                ...
                <button onClick={submitfile} style={buttonstyle} title="saveasimage">
